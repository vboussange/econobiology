...
dig = "1digit"
name_scenario = "synthetic_data_v2_alphan_$(dig)"
country = "FRA"
loop = true
verbose = true
plotting  = false
...
res_fitted = df_arr_sorted[(df_arr_sorted.Model .== Ref(L"\mathcal{M}_{\alpha^-}")) .* (df_arr_sorted.group_size_init .==  16) .* (df_arr_sorted.country .==  "FRA"), :Result][1]
